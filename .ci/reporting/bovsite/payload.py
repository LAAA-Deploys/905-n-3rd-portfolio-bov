...
def _build_portfolio_payload(workspace: DealWorkspace) -> tuple[dict, dict, dict[str, str]]:
    ...
    payload = {
        ...
        "meta": {
            ...
            # The hub's own overview and positioning paragraphs. Optional: the
            # renderer falls back to its generic sentence and omits positioning.
            "portfolio_blurb": presentation.get("portfolio_blurb"),
            "portfolio_positioning": presentation.get("portfolio_positioning"),
        },
        "team": _resolved_team(presentation["team"]),
